...
#target points for transfer learning
# filename = r'target_points_100_3d.xlsx'
# df = pd.read_excel(filename)
...
score = mean_absolute_percentage_error(y_test, test_pred)
print("MAPE:", score)
mse = mean_squared_error(y_test, test_pred)
print("MSE:", mse)


y_plot_tr = svr.predict(np.c_[c.ravel(), z.ravel()]).reshape(c.shape)
